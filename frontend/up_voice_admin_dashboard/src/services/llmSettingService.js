...
/**
 * Simulate Multi-label Classification & Auto Routing.
 * @param {object} payload - { text, threshold }
 */
export async function testAutoRouting(payload) {
  const res = await api.post('/settings/test-routing', payload);
