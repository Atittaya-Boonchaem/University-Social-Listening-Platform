...
# Category endpoints
# ──────────────────────────────────────────────
@router.get("/categories", response_model=StandardResponse, tags=[TAG_MASTER_DATA])
...
@router.post("/categories", response_model=StandardResponse, status_code=201, tags=[TAG_SUPER_ADMIN])
def create_category(
    cat: CategoryCreate,
...
@router.put("/categories/{category_id}", response_model=StandardResponse, tags=[TAG_SUPER_ADMIN])
def update_category(
    category_id: int,
    cat: CategoryUpdate,
    db: Session = Depends(get_db),
...
@router.delete("/categories/{category_id}", response_model=StandardResponse, tags=[TAG_SUPER_ADMIN])
def delete_category(
    category_id: int,
    db: Session = Depends(get_db),
    current_user: User = Depends(get_current_user),
...
@router.post("/categories/{category_id}/import-data", response_model=StandardResponse, tags=[TAG_SUPER_ADMIN])
...
# ──────────────────────────────────────────────
@router.get("/statuses", response_model=StandardResponse, tags=[TAG_MASTER_DATA])
...
@router.get("/visibility-types", response_model=StandardResponse, tags=[TAG_MASTER_DATA])
...
# Problem CRUD
# ──────────────────────────────────────────────
@router.post("/create", response_model=StandardResponse, status_code=201, tags=[TAG_USER_PROBLEMS])
async def create_problem(
    ...
    # Multi-label AI Classification & Cross-Department Routing
...
@router.get("/my-problems", response_model=StandardResponse, tags=[TAG_USER_PROBLEMS])
...
@router.get("/analytics", response_model=StandardResponse, tags=[TAG_CATEGORY_ADMIN])
...
@router.get("/analytics/time-series", response_model=StandardResponse, tags=[TAG_CATEGORY_ADMIN])
...
@router.get("/analytics/user-reputation", response_model=StandardResponse, tags=[TAG_CATEGORY_ADMIN])
def get_user_reputation_analytics(
    db: Session = Depends(get_db),
    current_user: User = Depends(get_current_user)
):
    require_admin_or_staff(current_user, db)
...
@router.get("/analytics/report", response_model=StandardResponse, tags=[TAG_SUPER_ADMIN])
...
@router.get("/analytics/sla-breached", response_model=StandardResponse, tags=[TAG_CATEGORY_ADMIN])
def get_sla_breached_analytics(
...
@router.post("/merge-duplicate", response_model=StandardResponse, tags=[TAG_CATEGORY_ADMIN])
...
@router.patch("/bulk-update", response_model=StandardResponse, tags=[TAG_CATEGORY_ADMIN])
...
@router.get("/{problem_id}", response_model=StandardResponse, tags=[TAG_USER_PROBLEMS])
...
@router.patch("/{problem_id}/status", response_model=StandardResponse, tags=[TAG_CATEGORY_ADMIN])
...
@router.get("/{problem_id}/status-history", response_model=StandardResponse, tags=[TAG_USER_PROBLEMS])
...
@router.post("/{problem_id}/comments", response_model=StandardResponse, status_code=201, tags=[TAG_USER_PROBLEMS])
...
@router.get("/{problem_id}/comments", response_model=StandardResponse, tags=[TAG_USER_PROBLEMS])
...
@router.post("/{problem_id}/like", response_model=StandardResponse, tags=[TAG_USER_PROBLEMS])
...
@router.delete("/{problem_id}", response_model=StandardResponse, tags=[TAG_SUPER_ADMIN])
def delete_problem(
    problem_id: int,
    db: Session = Depends(get_db),
    current_user: User = Depends(get_current_user),
...
@router.patch("/{problem_id}", response_model=StandardResponse, tags=[TAG_USER_PROBLEMS])
...
@router.post("/ai/expand-description", response_model=StandardResponse, tags=[TAG_AI_SERVICES])
...
@router.post("/ai/suggest-category", response_model=StandardResponse, tags=[TAG_AI_SERVICES])
...
@router.post("/ai/generate-category-desc", response_model=StandardResponse, tags=[TAG_AI_SERVICES])
...
@router.post("/ai/check-duplicate", response_model=StandardResponse, tags=[TAG_AI_SERVICES])
...
@router.get("/{problem_id}/ai-analysis", response_model=StandardResponse, tags=[TAG_AI_SERVICES])
...
@router.post("/ai/chat-assist", tags=[TAG_AI_SERVICES])
